...
const Navbar = ({children}: any) => {
  ...
  return (
      <>
      <div className=" bg-[#161D2F] sticky p-4 flex items-center justify-between md:p-6 lg:fixed lg:h-5/6 lg:flex-col lg:py-6  ">
        <div>
          <svg
            width="32"
            height="26"
        ...
        {/* nav-icons */}
        <div>
          <ul className="flex items-center  justify-between lg:flex-col lg:flex-wrap lg:space-y-10 max-lg:space-x-6 max-md:space-x-4">
            <li>
              <Link to="/">
                <svg
                  width="20"
                ...
                >
                  <path
                    ...
                    fill={currentLocation === "/" ? "white" : "grey"}
                  />
                </svg>
              </Link>
            </li>
            <li>
              <Link
                to="/movies"
                className={
                  currentLocation === "/movies" ? "bg-white" : "bg-slate-500"
                }
              >
                <svg
                  width="20"
                ...
                >
                  <path
                    ...
                    fill={currentLocation === "/movies" ? "white" : "grey"}
                  />
                </svg>
              </Link>
            </li>
              ...
              <Link to="/series">
                ...
                >
                  <path
                    ...
                    fill={currentLocation === "/series" ? "white" : "grey"}
                  />
                </svg>
              </Link>
            </li>
              ...
              <Link to="/bookmarks">
                ...
                >
                  <path
                    ...
                    fill={currentLocation === "/bookmarks" ? "white" : "grey"}
                  />
                </svg>
              </Link>
            </li>
        ...
        <div className="">
          <img
            ...
            src="https://images.unsplash.com/photo-1499482125586-91609c0b5fd4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80"
          />
        </div>
      </div>
      {children}
